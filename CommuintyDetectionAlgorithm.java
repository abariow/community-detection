...
public class CommuintyDetectionAlgorithm {
    ...
    public void start() {
        ...
        while (nn < 100) {
            ...
            Test test = new Test();
            try {
                NMI = test.NMI(myGraph.result, "/home/hossein/Desktop/T/TestCase14-N100000-k20-mu50/community.txt");
            } catch (Exception e) {
                e.printStackTrace();
            }
            nn++;
...
//        java.lang.System.out.println(myGraph);
    ...
    public void init() {
        ...
        File myfile = new File("/home/hossein/Desktop/T/TestCase14-N100000-k20-mu50/network.txt");
        try {
